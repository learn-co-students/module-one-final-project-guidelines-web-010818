...
Suspect.find_or_create_by( name: "Carmen Sandiego",
  ...
  meatpacking.clues << Clue.create(text: "I saw a hotel keycard in their pocket. I can't remember exactly, but it was either the Gansevoort Hotel or the Standard High Line.")
  meatpacking.clues << Clue.create(text: "They recommended checking out The Whitney.")
  meatpacking.clues << Clue.create(text: "They mentioned a park on the railroad tracks. I'm not sure what that means.")
  meatpacking.clues << Clue.create(text: "It sounded like they are planning to hit up some clubs tonight.")
  meatpacking.clues << Clue.create(text: "They kept bragging about being selected for an upcoming photo shoot for the 'World's Hottest Criminals' calendar. Maybe take a look at Milk Studios.")
  meatpacking.clues << Clue.create(text: "I don't know what it meant, but I heard them say 'MePa' a couple of times. Very weird.")
  ...
  soho.clues << Clue.create(text: "It sounded like they were taking Broadway down to their next location.")
  ...
  uws.clues << Clue.create(text: "I didn't hear too much, but I think I overhead something about Columbus Circle.")
  uws.clues << Clue.create(text: "Their stomach kept grumbling and they mentioned going to get something to eat from the original Zabar's.")
  ...
  uws.clues << Clue.create(text: "They are planning on taking a bike ride in Riverside Park.")

  west_village.clues << Clue.create(text: "I think they are heading to Greenwich Village.")
  ...
  west_village.clues << Clue.create(text: "They let it slip that they are going to see the site of the Stonewall riots.")
